# Social Engineering Awareness Campaign: Quid Pro Quo Attack Training

## What I Was Solving

Organizations spend millions on firewalls and encryption, but social engineering still works because it exploits human trust, not technology. Employees often do not recognize when they are being manipulated into giving away credentials or sensitive information.
...
A simulated job opportunity link was sent to 25 employees via email. 19 out of 25 clicked the link and submitted their credentials through a Google Form, a 76% susceptibility rate. No warnings, no hesitation. They trusted it.
...
1. **Threat Scenario Analysis:** Developed a realistic workplace attack scenario, an HR impersonation email offering a $500 reward for completing a feedback survey
2. **Baseline Assessment:** Surveyed 15 participants to understand current awareness levels
...
| Metric | Result |
|---|---|
| Employees targeted | 25 |
| Employees who fell for it | 19 |
| Susceptibility rate | 76% |

19 people submitted their credentials to a fake Google Form believing it was a legitimate job opportunity. The link was not sophisticated. The scenario was not elaborate. It worked because people trust what looks familiar.

**Awareness Survey Results (15 participants):**
- 47% had already experienced suspicious offers directly
- 40% had no prior experience with suspicious offers
- 13% knew someone who had been targeted

Nearly half had already been targeted in real life, yet many did not recognize it as an attack at the time. The simulation and survey together confirmed the same thing: the gap between exposure and awareness is wide.
...
- **Real data changes everything.** "Employees might fall for phishing" is a concern. "19 out of 25 did" is a finding that demands action. Evidence turns training from a checkbox into a justified control.
- **Scenario-based training works better than abstract warnings.** "Don't click suspicious links" doesn't stick. A specific, believable scenario that mirrors real workplace processes does.
